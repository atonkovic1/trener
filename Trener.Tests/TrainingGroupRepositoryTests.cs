...
{
    [TestClass]
    public class TrainingGroupRepositoryTests
    {
        ...
        public void Test_AddTrainingGroup()
        {
            ...
            TrainingGroup trainingGroup = new TrainingGroup("Grupa za testiranje", training,
                new List<TrainingPeriod> { trainingPeriod1, trainingPeriod2 },
                350.00M);
        ...
        [TestMethod]
        [ExpectedException(typeof(NonexistantNameException))]
        public void Test_GetTrainingGroupWithNonexistantName()
        {
            trainingGroupRepository.GetTrainingGroupWithName("test");
        }
    }
}