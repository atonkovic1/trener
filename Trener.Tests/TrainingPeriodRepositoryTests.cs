...
{
    [TestClass]
    public class TrainingPeriodRepositoryTests
    {
        ...
        [TestMethod]
        public void Test_AddTrainingPeriod()
        {
            TrainingPeriod trainingPeriod = new TrainingPeriod(DayOfWeek.Sunday,
                new TimeSpan(10, 0, 0), new TimeSpan(12, 0, 0));

            trainingPeriodRepository.AddTrainingPeriod(trainingPeriod);

            Assert.IsTrue(trainingPeriodRepository.GetAllTrainingPeriods().Contains(trainingPeriod));

            trainingPeriodRepository.RemoveTrainingPeriodWithId(trainingPeriod.PeriodId);
        }

        [TestMethod]
        [ExpectedException(typeof(PeriodAlreadyTakenException))]
        public void Test_AddTrainingPeriodOverlappingExistingTrainingPeriod()
        {
            TrainingPeriod trainingPeriod1 = new TrainingPeriod(DayOfWeek.Sunday,
                new TimeSpan(10, 0, 0), new TimeSpan(12, 0, 0));
            TrainingPeriod trainingPeriod2 = new TrainingPeriod(DayOfWeek.Sunday,
        ...
        [TestMethod]
        [ExpectedException(typeof(NonexistantIdException))]
        public void Test_RemoveTrainingPeriodWithNonexistantId()
        {
            trainingPeriodRepository.RemoveTrainingPeriodWithId(99999);
        }
    }
}